 ...
 * <br>
 *     16 April 2020, Barthelemy Martinon,    Added checkStatus boolean parameter for Novel constructor.
 * <br>
...
public class Novel extends Item {
	...
	public Novel(int ID, boolean checkStatus, String title, String author, String publisher, int year, String genre){
