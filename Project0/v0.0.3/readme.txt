...
Please see the folder named "supporting documentation" for:
	...
	"User Stories.rtf" 			describes the user stories.
	"Screens and User Stories.drawio" 	names the console screens, and each screen's interaction with individual user stories and specific parts of the database.