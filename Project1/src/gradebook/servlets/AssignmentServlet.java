...
public class AssignmentServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		if(assignmentId == null && reqAssignmentId == null) {
			...
			if(reqAssignmentId != null) {
				session.setAttribute("assignment_id", reqAssignmentId);
			}
			doPost(req, resp);
		}		
	}
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		if (course_id == null || assignment_id <= 0)
			...
			out.println("<p class=\"text\" style=\"white-space: pre-wrap; max-width: 350px;\">" + assignment.getBody() + "</p><br>");
