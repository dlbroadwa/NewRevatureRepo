...
import auction.bidding.AuctionBid;
 ...
 *
    ...
    public List<AuctionBid> retrieveAll() {
        ...
        try {
            ...
            while (resultSet.next()) {
                //bankAccounts.add(new AuctionBid(resultSet.getInt("auctionid"), resultSet.getInt("bidderid"),
    ...
    public boolean update(AuctionBid newObj) {
        ...
        try
        {
            ...
            //auctionBidStatement.setInt(1, newObj.getBidAmount());
            //auctionBidStatement.setInt(3, newObj.getTimeStamp());
