...
import Screens.ManagerViewSingleAccountMenu;
...
public class BankATM {
    public static void main (String args[]) {
        ...
        ConnectionUtils connect = new com.utilities.PostgresConnectionUtil(
                "jdbc:postgresql://project0nathan.crq2hafydb4f.us-east-2.rds.amazonaws.com:5432/postgres",
                "nathan", "nathannguyen", "myschema");


        IBankUsers<Users, String> IBankUsers = new BankUsersInSQLRepo(connect) ;
        UsersService usersService = new UsersService(IBankUsers);

        IAccounts<Accounts, Integer> IAccountHolders = new AccountsInSQLRepo(connect);
        AccountsService accountsService = new AccountsService(IAccountHolders);

        ITransaction<Transactions, Integer> ITransactions = new TransactionsSQLRepo(connect);
         ...
         */
        Screens.ATMLogInScreen atmLogInScreen = new ATMLogInScreen();
