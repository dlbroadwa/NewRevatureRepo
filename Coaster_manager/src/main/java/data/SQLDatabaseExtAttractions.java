...
//Methods
    ...
    public List<Attraction> findAll() {//Start of findAll method
        ...
        String sql = "Select name,external_attractions.attractionid,imageurl,ratings,status, isactive  from "+ schema +".external_attractions "+
        ...
        try (Connection conn = connectionUtil.getConnection();
            ...
            while (rs.next()) {
                if(rs.getBoolean("isactive")||rs.getString("status")==null) {
    ...
    public Attraction findByID(Integer integer) {//Start of findByID method
        ...
        String sql ="Select name,external_attractions.attractionid,imageurl,ratings,status, isactive from "+schema+
