...
public class PetSQLRepository implements Repository<Pet, Integer> {
    ...
    public Pet search(String petType, String petGender, Integer petAge){
        ...
        try {
            ...
            while(rs.next()) {
                ...
                if (petType.equals("dog")) {
                    pet = new Dog(petID,name,breed,petGender,petAge);
                } else if (petType.equals("cat")) {
                    pet = new Cat(petID,name,breed,petGender,petAge);
                }
            }
        } catch (SQLException throwables) {
            throwables.printStackTrace();
